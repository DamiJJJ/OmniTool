        ...
        if city:
            ...
            try:
                ...
                current_weather_data = {
                    ...
                    "description": first_forecast["weather"][0][
                        "description"
                    ].capitalize(),
                        ...
                        today_hourly_forecast.append(
                            {
                                ...
                                "description": forecast_item["weather"][0][
                                    "description"
                                ],
                            }
                        )
                    ...
                    if day_dt_object > today:
                        ...
                        for item in day_forecast_items:
                            if (
                                ...
                                break
                        if (
                            not representative_forecast and day_forecast_items
                        ):  # Fallback to first if no midday entry
                            ...
                            upcoming_daily_forecast_grouped.append(
                                {
                                    ...
                                    "min_temp": min_temp,
                                    "max_temp": max_temp,
                                    "icon": representative_forecast["weather"][0][
                                        "icon"
                                    ],
                                    "description": representative_forecast["weather"][
                                        0
